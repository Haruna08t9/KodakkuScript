...
public class EdenUltimate
{
	...
	public void P1_转轮召_击退处理位置(Event @event, ScriptAccessory accessory)
	{
		...
		List<int> P1转轮召抓人HTD = [P1转轮召抓人[2], P1转轮召抓人[3], P1转轮召抓人[0], P1转轮召抓人[1], P1转轮召抓人[4], P1转轮召抓人[5], P1转轮召抓人[6], P1转轮召抓人[7]];
		var o1 = P1转轮召抓人HTD.IndexOf(1);
		var o2 = P1转轮召抓人HTD.LastIndexOf(1);
		var o1HTD = 0;
		var o2HTD = 0;
		switch (o1){
			case 0:
		...
		List<int> upGroup = [];
			...
			upGroup.Add(o1HTD);
			if (o1 != 0 && o2 != 0) upGroup.Add(2);
			if (o1 != 1 && o2 != 1) upGroup.Add(3);
			if (o1 != 3 && o2 != 3) upGroup.Add(1);
			if (upGroup.Count < 4 && o1 != 2 && o2 != 2) upGroup.Add(0);
	...
	public void P1_四连线_处理位置(Event @event, ScriptAccessory accessory)
	{
		...
		{
			var myindex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
			Vector3 t1p1 = new(100 - far, 0, 100);
			Vector3 t1p2 = new(100 - far - dis, 0, 100);
			Vector3 t2p1 = new(100 + far, 0, 100);
			Vector3 t2p2 = new(100 + far + dis, 0, 100);
			Vector3 t3p1 = new(100 - far - dis, 0, 100);
			Vector3 t3p2 = new(100 - far, 0, 100);
			Vector3 t4p1 = new(100 + far + dis, 0, 100);
			Vector3 t4p2 = new(100 + far, 0, 100);
			...
			if (P1四连线.Count == 4)
			{
				...
				List<int> idleObjIndex = [];
					List<int> group = [2, 3, 0, 1, 4, 5, 6, 7];
					group.RemoveAll(x => tehterObjIndex.Contains(x));
					idleObjIndex.AddRange(group);

				if (!idleObjIndex.Contains(myindex)) return;

				Vector3 i1p1 = tehterIsFire[0] ? new(100 - far - dis, 0, 100) : new(100 - far, 0, 100 - dis);
				Vector3 i1p2 = tehterIsFire[2] ? new(100 - far - dis, 0, 100) : new(100 - far, 0, 100 - dis);
				Vector3 i2p1 = tehterIsFire[0] ? new(100 - far - dis, 0, 100) : new(100 - far, 0, 100 + dis);
				Vector3 i2p2 = tehterIsFire[2] ? new(100 - far - dis, 0, 100) : new(100 - far, 0, 100 + dis);
				Vector3 i3p1 = tehterIsFire[1] ? new(100 + far + dis, 0, 100) : new(100 + far, 0, 100 - dis);
				Vector3 i3p2 = tehterIsFire[3] ? new(100 + far + dis, 0, 100) : new(100 + far, 0, 100 - dis);
				Vector3 i4p1 = tehterIsFire[1] ? new(100 + far + dis, 0, 100) : new(100 + far, 0, 100 + dis);
				Vector3 i4p2 = tehterIsFire[3] ? new(100 + far + dis, 0, 100) : new(100 + far, 0, 100 + dis);
		...
		Task.Delay(100).ContinueWith(t =>
		{
			...
			if (@event["ActionId"] == "40134")
			{
				...
				else
				{
					...
					if (myindex == 4)
					{
						if (P1塔[0] == 2 || P1塔[0] == 3 || P1塔[0] == 4) 
						{ 
							dealpos = new(eastTower ? 113.08f : 86.92f, 0, 90.81f);
						}
						else if (P1塔[1] == 2 || P1塔[1] == 3 || P1塔[1] == 4)
						{
							dealpos = new(eastTower ? 115.98f : 84.02f, 0, 100f);
						}
						else dealpos = new(eastTower ? 113.08f : 86.92f, 0, 109.18f);						
					}
					if (myindex == 5)
					{
						if (P1塔[0] == 3 || P1塔[0] == 4)
					...
					if (myindex == 6)
					{
						...
						else dealpos = new(eastTower ? 113.08f : 86.92f, 0, 90.81f);
					}
					...
					if (myindex == 4)
					{
						if (P1塔[0] == 2 || P1塔[0] == 3 || P1塔[0] == 4)
						{
							towerpos = new(eastTower ? 113.08f : 86.92f, 0, 90.81f);
						}
						else if (P1塔[1] == 2 || P1塔[1] == 3 || P1塔[1] == 4)
						{
							towerpos = new(eastTower ? 115.98f : 84.02f, 0, 100f);
						}
						else towerpos = new(eastTower ? 113.08f : 86.92f, 0, 109.18f);
					}
					if (myindex == 5)
					{
						if (P1塔[0] == 3 || P1塔[0] == 4)
					...
					if (myindex == 6)
					{
						...
						else towerpos = new(eastTower ? 113.08f : 86.92f, 0, 90.81f);
					}
			...
			else
			{
				...
				else
				{
					...
					if (myindex == 4)
					{
						if (P1塔[0] == 2 || P1塔[0] == 3 || P1塔[0] == 4)
						{
							dealpos = new(eastTower ? 102f : 98f, 0, 90.81f);
						}
						else if (P1塔[1] == 2 || P1塔[1] == 3 || P1塔[1] == 4)
						{
							dealpos = new(eastTower ? 102f : 98f, 0, 100f);
						}
						else dealpos = new(eastTower ? 102f : 98f, 0, 109.18f);
					}
					if (myindex == 5)
					{
						if (P1塔[0] == 3 || P1塔[0] == 4)
						...
						{
							dealpos = new(eastTower ? 102f : 98f, 0, 109.18f);
						}
						else dealpos = new(eastTower ? 102f : 98f, 0, 100f);
					}
					if (myindex == 6)
					{
						if (P1塔[2] == 2 || P1塔[2] == 3 || P1塔[2] == 4)
						...
						else dealpos = new(eastTower ? 102f : 98f, 0, 90.81f);
					}
	...
	public void P2_钻石星尘_冰花放置位置(Event @event, ScriptAccessory accessory)
	{
		...
		if (myIndex == 4 || myIndex == 5 || myIndex == 6 || myIndex == 7)
		{
			dealpos1 = RotatePoint(epos1, new(100, 0, 100), float.Pi / 4 * (rot + dr));
			dealpos2 = RotatePoint(epos2, new(100, 0, 100), float.Pi / 4 * (rot + dr));
		}
		if (myIndex == 0 || myIndex == 1 || myIndex == 2 || myIndex == 3)
		{
			dealpos1 = RotatePoint(epos1, new(100, 0, 100), float.Pi / 4 * (rot - dr));
			dealpos2 = RotatePoint(epos2, new(100, 0, 100), float.Pi / 4 * (rot - dr));
		}
	...
	public void P2_钻石星尘_扇形引导位置(Event @event, ScriptAccessory accessory)
	{
		...
		Vector3 dealpos = RotatePoint(epos, new(100, 0, 100), float.Pi / 4 * (rot + dr));
		if (myIndex == 4 || myIndex == 5 || myIndex == 6 || myIndex == 7)
		{
			dealpos = RotatePoint(epos, new(100, 0, 100), float.Pi / 4 * (rot + dr));
		}
		if (myIndex == 0 || myIndex == 1 || myIndex == 2 || myIndex == 3)
		{
			dealpos = RotatePoint(epos, new(100, 0, 100), float.Pi / 4 * (rot - dr));
	...
	public void P2_双镜_分散分摊(Event @event, ScriptAccessory accessory)
	{
		...
		else
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				dp.Scale = new(5);
				dp.Owner = accessory.Data.PartyList[i];
				dp.Color = group[i] == myindex || i == myindex ? accessory.Data.DefaultSafeColor : accessory.Data.DefaultDangerColor;
				dp.DestoryAt = 5000;
				accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp);
			}
		}
	...
	public void P3_时间压缩_头标(Event @event, ScriptAccessory accessory)
	{
		...
		if (P3FireBuff[myPartyIndex] == 1)
		{
			if (myPartyIndex < 4)
			{
				accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack3, false);
			}
			else
			{
				...
				{
					accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack1, false);
				}
				else
				{
					accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack2, false);
				}
			}
		...
		{
			if (myPartyIndex < 4) accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Stop1, false);
			else accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Stop2, false);
		}
		//长火
		if (P3FireBuff[myPartyIndex] == 3)
		{
			if (myPartyIndex < 4)
			{
				...
				{
					accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Bind1, false);
				}
				else
				{
					accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Bind2, false);
				}
			}
			else
			{
				accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Bind3, false);
			}
		...
		{
			if (myPartyIndex < 4) accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack3, false);
			else accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Bind3, false);
		}
	}
	...
	public void P3_时间压缩_破盾一击集合提示(Event @event, ScriptAccessory accessory)
	{
		...
		accessory.Method.SendChat("/mk clear <me>");
	}
	...
	public void P4_暗光龙诗_引导处理位置(Event @event, ScriptAccessory accessory)
	{
		...
		Task.Delay(50).ContinueWith(t =>
		{
			...
			Vector3 dealpos = new(100f,0,100f);
			if (P4triggertimes == P4triggertime.扇后)
			{
				dealpos = idles.IndexOf(myIndex) switch
				{
					1 => new(095.8f, 0, 098.0f),
					0 => new(104.2f, 0, 098.0f),
					2 => new(095.8f, 0, 102.0f),
					3 => new(104.2f, 0, 102.0f),
				};

			}
			if (P4triggertimes == P4triggertime.扇前)
			{
				var tIndex = P4Tether[0] == -1 ? 1 : 0;
				var nIndex = P4Tether[2] == -1 ? 3 : 2;
				var d1Index = -1;
	...
	public void P4_时间结晶_头标(Event @event, ScriptAccessory accessory)
	{
		...
		if (!ParseObjectId(@event["TargetId"], out var tid)) return;
		var myIndex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
		switch (P4OtherBuff[myIndex])
		{
			case 1:
				if (P4ClawBuff[myIndex] == 3)
				{
					accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack1, false);
					accessory.Method.TextInfo("吃B点白圈", 5);
					accessory.Method.SendChat("/e 吃B点白圈");
				}
				break;
			case 3:
				accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack3, false);
				accessory.Method.SendChat("/e 吃3点白圈");
				accessory.Method.TextInfo("吃3点白圈", 5);
				break;
			case 4:
				accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack4, false);
				accessory.Method.SendChat("/e 吃D点白圈");
				accessory.Method.TextInfo("吃D点白圈", 5);
				break;
			case 5:
				accessory.Method.Mark(accessory.Data.Me, KodakkuAssist.Module.GameOperate.MarkType.Attack2, false);
				accessory.Method.SendChat("/e 吃2点白圈");
				accessory.Method.TextInfo("吃2点白圈", 5);
				break;
		}
	}
	...
	public void P4_时间结晶_Buff处理位置(Event @event, ScriptAccessory accessory)
	{
		...
		if (parse != 4.3) return;
		var myIndex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
		List<int> P4ClawBuffHTD = [P4ClawBuff[2], P4ClawBuff[0], P4ClawBuff[1], P4ClawBuff[4], P4ClawBuff[5], P4ClawBuff[6], P4ClawBuff[7], P4ClawBuff[3]];
		int myIndexHTD;
		switch (myIndex)
		{
			case 0:
		...
		{
			var isHigh = P4ClawBuffHTD.IndexOf(1) == myIndexHTD;
		...
		{
			var isHigh = P4ClawBuffHTD.IndexOf(2) == myIndexHTD;
	...
	public void P4_时间结晶_放回返位置(Event @event, ScriptAccessory accessory)
	{
		...
		var myindex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
		Vector3 centre = new(100, 0, 100);
		var dir8 = PositionTo8Dir( P4WaterPos[1], centre);//0或4
		Vector3 mtPos = new(94, 0, 94);
		Vector3 stPos = new(106, 0, 94);
		Vector3 mtgPos = new(100, 0, 97);
		Vector3 stgPos = new(100, 0, 97);
		if (myindex == 0)
		{
			var dp = accessory.Data.GetDefaultDrawProperties();
